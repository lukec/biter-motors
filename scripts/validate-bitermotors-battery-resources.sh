...
{"name":"bitermotors_battery_resource_test","version":"0.1.1","title":"Biter Motors Battery Resource Test","author":"Codex","factorio_version":"2.1","dependencies":["base >= 2.1.0","space-age >= 2.1.0","bitermotors >= 0.1.0"]}
EOF
