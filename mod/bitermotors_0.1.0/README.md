...
7. Build 100 Premium EVs to unlock Gigafactory construction.
8. Establish nickel, lithium, high-nickel, LFP, waste, and recycling loops.
9. Scale High-density Solar Panels, Megapacks, advanced chargers, Gigafactories,
   and Mass-market EVs.
...
- V3 Supercharger: 12 stalls, 32 EVs per stall, 250 kW per active stall.
- V4 Supercharger: 20 stalls, 50 EVs per stall, 500 kW per active stall.
- Gigafactory V1: 9x9, 20 MW, 4x crafting speed, 50% built-in productivity.
- Gigafactory V2: fast-replaceable 9x9 upgrade, 30 MW, 8x speed, 150%
  built-in productivity.
- High-density Solar Panel: upgradeable 3x3 panel producing 300 kW.
- Megapack: 100 MJ storage with 5 MW charge and discharge.
...
- Robotaxi: efficient long-duty fleet vehicle.
...
Premium, Mass-market, Megatruck, and Robotaxi vehicles support Navigate and
