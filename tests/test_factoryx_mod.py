...
class FactoryXModTest(unittest.TestCase):
    ...
    def test_sales_office_panel_explains_market_saturation(self):
        ...
        self.assertIn('string.format("%d remaining; all assigned"', control)
        self.assertIn('"%d remaining; %d unassigned"', control)
        self.assertIn('return "All prospects assigned", FACTORYX_STATE_COLORS.warning', control)
        self.assertIn('"Low prospects"', control)
        self.assertIn("SALES_OFFICE_LOW_PROSPECT_FRACTION = 0.20", control)
        self.assertIn("Assigned prospects are reserved by an active Sales Office sale.", control)
        self.assertIn("Overlapping Sales Offices share the same prospect pool.", control)
    ...
    def test_accelerated_start_is_light_optional_and_narrated(self):
        ...
        self.assertIn('FACTORYX_ENERGY_JUMPSTART_NORMAL_QUALITY_ITEMS', jumpstart)
        self.assertIn('FACTORYX_ENERGY_JUMPSTART_NORMAL_QUALITY_ITEMS[item_name]', control)
    ...
    def test_sales_follow_covered_home_settlements_not_wandering_unit_positions(self):
        ...
        self.assertIn('label = "Prospects"', control)
        self.assertIn("all prospects are assigned to active sales", control)
    ...
    def test_gigafactory_v1_is_large_and_builds_premium_evs(self):
        ...
        self.assertNotIn('"x-dollar"', logistic_rewrite)
    ...
    def test_vehicle_sales_require_living_mobile_buyers_and_track_ownership(self):
        ...
        self.assertIn("Waiting for an unassigned prospect.", control)
