...
class FactoryXModTest(unittest.TestCase):
    ...
    def test_factoryx_charging_network_sales_loop(self):
        ...
        self.assertIn('charger_wire.real_connection_count ~= 1', control)
        self.assertIn('charger_wire.disconnect_all()', control)
        self.assertIn('charger_wire.connect_to(grid_wire, false)', control)
